...
type BrandInfoSheetProps = Omit<BottomSheetModalProps, 'children' | 'snapPoints'> & {
  brand: string;
};
        ...
        >
          ...
          <View className="mb-6">
            ...
            <Text className="text-sm font-inter text-muted-foreground leading-6 mb-4">
              This product is sold by {brand}, a trusted brand curated by Auntie Marlene's.
              We work with brands that share our commitment to quality, sustainability,
          ...
          <View className="mb-6">
            ...
            <View className="gap-2">
              <View className="flex-row justify-between py-2">
                <Text className="text-sm font-inter text-muted-foreground">Sold by</Text>
                <Text className="text-sm font-inter-semibold text-foreground">
                  {brand}
                </Text>
              </View>
              <View className="flex-row justify-between py-2">
                <Text className="text-sm font-inter text-muted-foreground">Shipped by</Text>
                <Text className="text-sm font-inter-semibold text-foreground">
                  Auntie Marlene's
                </Text>
              </View>
          ...
          <View className="bg-warm-beige rounded-lg p-4">
            <Text className="text-xs font-inter text-muted-foreground leading-5">
              All products are carefully selected and verified by Auntie Marlene's
              to ensure they meet our high standards for quality and authenticity.
            </Text>
          </View>
        </BottomSheetScrollView>
      </BottomSheetModal>
