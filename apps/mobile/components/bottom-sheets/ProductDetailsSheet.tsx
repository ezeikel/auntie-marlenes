...
type ProductDetailsSheetProps = Omit<BottomSheetModalProps, 'children' | 'snapPoints'> & {
  description: string;
};

const ProductDetailsSheet = forwardRef<BottomSheetModal, ProductDetailsSheetProps>(
