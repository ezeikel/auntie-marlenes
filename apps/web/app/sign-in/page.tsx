...
const SignInContent = () => {
  ...
  return (
    <div className="bg-warm-beige min-h-screen py-12 md:py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-md mx-auto">
            ...
            {emailSent ? (
              ...
              <>
                ...
                <div className="space-y-3 mb-6">
                  ...
                  >
                    <FontAwesomeIcon icon={faApple} className="mr-3 text-lg" />
                    Continue with Apple
                  </Button>
                </div>
          ...
          <div className="mt-12 grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <div className="text-sage-green text-2xl mb-2">🎁</div>
              <p className="text-xs text-gray-600 font-inter">Member Rewards</p>
            </div>
          </div>
        </div>
      </div>
...
const SignInPage = () => {
  return (
    <Suspense fallback={<div className="bg-warm-beige min-h-screen" />}>
      <SignInContent />
    </Suspense>
  );
};
